      ...
      <div ref={containerRef} className="min-h-screen bg-black text-white selection:bg-white/10 overflow-hidden font-sans">
         ...
         <nav className="fixed top-0 w-full z-[100] px-8 md:px-16 py-8 flex justify-between items-center mix-blend-difference">
            <div className="flex items-center gap-6 group cursor-pointer">
               <div className="relative w-12 h-12 flex items-center justify-center border border-white/10 group-hover:border-white/40 transition-all duration-700">
                  <span className="text-xl font-medium italic tracking-tighter relative z-10">M</span>
               </div>
               <div className="flex flex-col hidden sm:flex">
                  <span className="text-[13px] font-semibold uppercase tracking-[0.5em]">Maven Studio</span>
                  <span className="text-[8px] uppercase tracking-[0.3em] opacity-50 font-medium">Architectural AI Bureau</span>
               </div>
            </div>

            <div className="hidden lg:flex gap-16 text-[10px] font-medium uppercase tracking-[0.4em]">
            ...
            <motion.button
               ...
               className="px-8 py-3 bg-white/10 backdrop-blur-md text-white border border-white/20 hover:bg-white hover:text-black transition-all duration-500 text-[10px] font-semibold uppercase tracking-widest"
            >
               Обсудить проект
            </motion.button>
         </nav>
            ...
            <section className="relative h-screen flex flex-col justify-center items-center text-center px-6 overflow-hidden">
               ...
               <div className="relative z-10 hero-parallax">
                  <motion.div
                     ...
                     animate={{ opacity: 0.5, tracking: "1.2em" }}
                     transition={{ duration: 3 }}
                     className="text-[9px] font-semibold uppercase mb-12 text-white/60"
                  >
                  ...
                  <motion.h1
                     ...
                     className="text-[15vw] lg:text-[12vw] font-extrabold leading-[0.75] text-gradient uppercase mb-12 tracking-tightest"
                  >
                  ...
                  <motion.p
                     ...
                     className="text-lg md:text-xl font-light max-w-2xl mx-auto leading-relaxed tracking-[0.4em] uppercase italic text-white/80"
                  >
               ...
               >
                  <span className="shimmer-text text-[10px] font-medium uppercase tracking-[0.5em]">Scroll to Explore</span>
                  <motion.div 
                     animate={{ y: [0, 8, 0] }}
               ...
               <div className="max-w-7xl mx-auto relative z-10">
                  <div className="reveal-up">
                     <div className="flex items-center gap-4 mb-12">
                        ...
                        <span className="text-[11px] font-semibold text-white/40 uppercase tracking-[1em]">Chapter_01 / Expertise</span>
                     </div>
                     <h2 className="text-7xl md:text-9xl font-extrabold uppercase tracking-tightest leading-[0.8] mb-16 max-w-4xl">
                     ...
                     <div className="grid grid-cols-1 sm:grid-cols-2 gap-12 max-w-2xl">
                        {[
                           ...
                           <div key={i} className="group cursor-pointer">
                              ...
                              <h3 className="text-lg font-bold uppercase mb-2 tracking-tighter opacity-50 group-hover:opacity-100 transition-opacity">{item.title}</h3>
                              <p className="text-[10px] text-white/50 uppercase tracking-widest leading-loose">{item.desc}</p>
                           </div>
                        ))}
                     </div>
                  </div>
               ...
               <div className="max-w-7xl mx-auto w-full">
                  <div className="mb-32 reveal-up">
                     <div className="flex items-center gap-4 mb-8">
                        <div className="w-12 h-[1px] bg-white/20" />
                        <span className="text-[11px] font-medium text-white/50 uppercase tracking-[1em]">Chapter_02 / Process</span>
                     </div>
                     <h2 className="text-7xl md:text-[8vw] font-extrabold uppercase tracking-tightest leading-[0.8]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                     {[
                        ...
                        <div key={i} className="group relative p-12 rounded-[32px] bg-white/[0.02] border border-white/5 hover:bg-white/[0.05] transition-all duration-700 reveal-up overflow-hidden">
                           ...
                           {/* GHOST NUMBER */}
                           <span className="absolute -right-4 -bottom-8 text-[12rem] font-medium text-white/[0.03] group-hover:text-white/[0.08] transition-all duration-1000 select-none">
                              {item.step}
                           </span>

                           <div className="relative z-10">
                              <span className="text-[10px] font-semibold text-white/40 uppercase tracking-[0.5em] block mb-12">{item.step} — System</span>
                              <h3 className="text-xl font-bold uppercase mb-4 tracking-tight group-hover:text-gradient transition-all">{item.label}</h3>
                              <p className="text-[11px] text-white/60 tracking-wider leading-relaxed max-w-[240px]">
                                 {item.text}
                              </p>
                           </div>
                        </div>
               ...
               <div className="max-w-7xl mx-auto">
                  <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-40 reveal-up">
                     <div className="relative">
                        <div className="flex items-center gap-4 mb-8">
                           <div className="w-12 h-[1px] bg-white/20" />
                           <span className="text-[11px] font-medium text-white/50 uppercase tracking-[1em]">Chapter_03 / Artifacts</span>
                        </div>
                        <h2 className="text-7xl md:text-[10vw] font-extrabold uppercase tracking-tightest leading-[0.8]">
                           Цифровые <br /> <span className="text-gradient">Артефакты.</span>
                        </h2>
                     </div>
                     <div className="mt-12 md:mt-0 max-w-xs">
                        <p className="text-[10px] text-white/30 uppercase tracking-[0.4em] leading-loose font-medium border-l border-white/20 pl-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-24">
                     ...
                     <div className="md:col-span-8 group relative reveal-up">
                        <div className="relative aspect-[16/10] overflow-hidden rounded-[40px] border border-white/5 bg-zinc-950">
                           ...
                           {/* OVERLAY INFO */}
                           <div className="absolute inset-0 p-12 flex flex-col justify-end bg-gradient-to-t from-black/90 via-black/20 to-transparent pointer-events-none">
                              <span className="text-[10px] font-semibold text-white/60 uppercase tracking-widest mb-3">01 / Fintech Ecosystem</span>
                              <h3 className="text-3xl md:text-5xl font-bold tracking-tight mb-4 group-hover:text-gradient transition-all">Aeon Finance</h3>
                              <div className="flex gap-4">
                                 <span className="px-4 py-2 rounded-full border border-white/20 text-[9px] font-medium uppercase tracking-wider bg-white/5 backdrop-blur-sm">Neural Interface</span>
                                 <span className="px-4 py-2 rounded-full border border-white/20 text-[9px] font-medium uppercase tracking-wider bg-white/5 backdrop-blur-sm">Real-time Auth</span>
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div className="md:col-span-4 md:mt-48 group relative reveal-up">
                        <div className="relative aspect-[4/5] overflow-hidden rounded-[32px] border border-white/5 bg-zinc-950">
                           ...
                           {/* OVERLAY INFO */}
                           <div className="absolute inset-0 p-10 flex flex-col justify-end bg-gradient-to-t from-black/90 via-black/20 to-transparent pointer-events-none">
                              <span className="text-[10px] font-semibold text-white/60 uppercase tracking-widest mb-3">02 / Infrastructure</span>
                              <h3 className="text-2xl md:text-4xl font-bold tracking-tight mb-4">Cyber <br /> Logistics</h3>
                              <button className="flex items-center gap-3 text-[10px] font-medium uppercase tracking-wider text-white/60 group-hover:text-white transition-colors">
            ...
            <section id="контакты" className="min-h-screen py-32 px-8 md:px-24 flex flex-col justify-center relative">
               <div className="max-w-4xl mx-auto w-full">
                  <div className="mb-24 reveal-up text-center">
                     <h2 className="text-6xl md:text-[8vw] font-bold uppercase leading-[0.85] tracking-tight mb-12">
                     ...
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                        <div className="space-y-12">
                           <div className="border-b border-white/10 pb-6 focus-within:border-white transition-colors">
                               <label className="text-[10px] font-medium uppercase tracking-[0.3em] opacity-30 block mb-4">Your Identity</label>
                               <input type="text" placeholder="NAME" className="bg-transparent w-full outline-none text-xl font-medium placeholder:text-white/10" />
                           </div>
                           <div className="border-b border-white/10 pb-6 focus-within:border-white transition-colors">
                               <label className="text-[10px] font-medium uppercase tracking-[0.3em] opacity-30 block mb-4">Contact Gateway</label>
                               <input type="text" placeholder="TG / EMAIL" className="bg-transparent w-full outline-none text-xl font-medium placeholder:text-white/10" />
                           </div>
                        </div>
                        <div className="flex flex-col justify-end">
                           <motion.button
                              whileHover={{ scale: 1.02 }}
                              whileTap={{ scale: 0.98 }}
                              className="w-full py-8 bg-white/10 backdrop-blur-md text-white border border-white/20 hover:bg-white hover:text-black transition-all duration-700 text-[11px] font-semibold uppercase tracking-[0.4em] flex justify-center items-center gap-4 group rounded-2xl"
                           >
         ...
         <footer className="py-32 px-8 md:px-24 bg-black border-t border-white/5 relative z-10">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-end gap-16 opacity-20 hover:opacity-60 transition-opacity duration-1000">
               <div>
                  <span className="text-[10vw] font-extrabold uppercase tracking-tightest leading-none block -mb-4">MAVEN</span>
                  <span className="text-[10vw] font-extrabold uppercase tracking-tightest leading-none">STUDIO</span>
               </div>
               <div className="text-right space-y-6">
                  <div className="text-[9px] font-medium uppercase tracking-[1em] text-white/50">Autonomous Architecture Bureau</div>
                  <div className="text-[9px] uppercase tracking-[0.5em] flex gap-12 justify-end font-medium">
                     <span>ZURICH</span>
                     <span>DUBAI</span>
                     <span>LONDON</span>
                  </div>
                  <div className="pt-8 border-t border-white/10 text-[8px] opacity-40 tracking-[0.2em] font-light">© 2024 MAVEN STUDIO WORLDWIDE. BUILT IN SILENCE.</div>
               </div>
            </div>
         </footer>
      </div>
